    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                settings.put(Environment.URL, "jdbc:mysql://localhost:3306/projectwinedb?createDatabaseIfNotExist=true");
                ...
                configuration.addAnnotatedClass(tables.NotificationsEntity.class);
                configuration.addAnnotatedClass(tables.WarehouseEntity.class);
