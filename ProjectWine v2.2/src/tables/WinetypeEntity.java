...
public class WinetypeEntity {
    ...
    private Integer whiteGrapeNeeded;
    private Integer redGrapeNeeded;
    ...
    public Integer getWhiteGrapeNeeded() {
        return whiteGrapeNeeded;
    }

    public void setWhiteGrapeNeeded(Integer whiteGrapeNeeded) {
        this.whiteGrapeNeeded = whiteGrapeNeeded;
    }

    @Basic
    @Column(name = "RedGrapeNeeded")
    public Integer getRedGrapeNeeded() {
        return redGrapeNeeded;
    }

    public void setRedGrapeNeeded(Integer redGrapeNeeded) {
